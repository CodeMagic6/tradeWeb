      ...
      <div class="wd">
              ...
              <tr>
                <td style="width:20%">
                  <ul>
                    ...
                    <li>
                      <a href="/81/"
                        title="Honors">Honors</a>
                    </li>
                    <li>
                      <a href="/137/"
                        title="Office environment">Office environment</a>
                    </li>
        ...
        <div class="bottom">
          <div class="bottom-left">
            ...
            <a href="sitemap.xml"
              title="Site Map"
              target="_blank">Site Map</a><br /> Copyright &copy; 2015 Shenzhen De Qiang Electronics Co. Ltd.
          </div>

    ...
    <div class="right">
      ...
      <div class="prodes">
        <div class="pro_tab_nav">
          <span id="span1"
            class="span_on"
            onclick="gettab(1,2)">Description</span>
          <span id="span2"
            onclick="gettab(2,2)">Parameter</span>
        </div>
        <div id="tab1"
          class="tab_con"
          style="display:block;">
      ...
      <div>
        <div class="pro_tab_nav">
          <span class="span_on">Inquiry on line</span>
        </div>
      </div>
      <form id="messageform1"
        ...
        action=""
        method="post"
        onsubmit="return diyformsubmit(this)">
        <input class="post_"
          type="hidden"
          name="datatable"
          value="feedback">
        <input class="post_"
          type="hidden"
          name="sec"
          value="Congratulations, voice messages submitted to the success!">
        <input class="post_"
          type="hidden"
          name="classid"
          value="235">
        ...
        <input class="post_"
          type="hidden"
          name="filed"
          value="title|tel|username|email|content">
        <input type="hidden"
          id="pid"
          name="pid"
          value="0">
          ...
          <tbody>
            <tr>
              ...
              <td><input type="text"
                  ...
                  name="title"
                  style="width:300px;"
                  class="input_1 vderror post_Please leave your title"
                  value="">
            ...
            <tr>
              ...
              <td><input type="text"
                  ...
                  name="email"
                  style="width:300px;"
                  class="input_1 vderror post_Please Type in email">
                <font color="#FF0000">*</font>
              </td>
            </tr>
            <tr>
              <th class="feed-left">Tel:</th>
              <td><input name="tel"
                  id="tel"
                  class="feedinput post_Please leave your Contact telephone!"
                  type="text"></td>
            </tr>
            <tr>
              <th>Contact : </th>
              <td><input type="text"
                  ...
                  name="username"
                  style="width:200px;"
                  class="input_1 vderror post_Please Type in username">
                <font color="#FF0000">*</font>
              </td>
            </tr>
            <tr>
              ...
              <td><textarea id="content"
                  ...
                  class="input_1 vderror post_Input you content please!"></textarea>
                <font color="#FF0000">*</font>
              </td>
            </tr>
            <tr>
              <th></th>
              <td><input class="tijiao"
                  type="submit"
                  value="Submit"></td>
            </tr>
          </tbody>
...
.pro_tab_nav ul li:hover,
.pro_tab_nav ul li.hover {
  // background: url(../images/tabover_1.gif) no-repeat;
  cursor: pointer;
  color: #fff;
}
.prodes .pro_tab_nav ul li:hover .bg_right,
.prodes .pro_tab_nav ul li.hover .bg_right {
  // background: url(../images/tabover_right.gif) no-repeat;
  float: left;
  width: 8px;
}
